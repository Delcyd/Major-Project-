...
class App extends Component {
  ...
  transfer = reciever  => {
    ...
    //  console.log("Submitting file to IPFS...")
      ...
      // Add file to the IPFS
        ...
        this.state.dstorage.methods.transfer(reciever,10).send({ from: this.state.account }).on('transactionHash', () => {
  ...
  //  console.log("Submitting file to IPFS...")
    ...
    //  this.setState({ loading: true })
      ...
      this.state.dstorage.methods.login(password,'owner').send({ from: this.state.account }).on('transactionHash', (hash) => {
